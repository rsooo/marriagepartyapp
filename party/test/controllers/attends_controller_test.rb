...
class AttendsControllerTest < ActionController::TestCase
  ...
  test "should create attend" do
    assert_difference('Attend.count') do
      post :create, attend: { attend: @attend.attend, comment: @attend.comment, name: @attend.name, payment: @attend.payment }
    end
  ...
  test "should update attend" do
    patch :update, id: @attend, attend: { attend: @attend.attend, comment: @attend.comment, name: @attend.name, payment: @attend.payment }
    assert_redirected_to attend_path(assigns(:attend))
  end
